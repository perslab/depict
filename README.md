...
## Quick start
* To run DEPICT using precomputed loci (derived from the LDL cholesterol GWAS summary statistics) do
  * `python depict.py`
* To run DEPICT based on GWAS the LDL cholesterol summary statistics
