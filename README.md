...
## Example
1. Run DEPICT using precomputed LDL cholesterol loci (derived from LDL cholesterol GWAS summary statistics)
  * `python depict.py`
2. Run DEPICT directly on the LDL cholesterol summary statistics (this step computes the LDL cholesterol loci from step 1.)
